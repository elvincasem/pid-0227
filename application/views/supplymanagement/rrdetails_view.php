		...
		<div class="block full">
			...
			<div class="tab-content">
				...
				echo "<td class='center'> 
					...
					<button class='btn btn-danger notification' title='Delete User' id='notification' onClick='deletedritem(".$drlistitems['deliveryitemsid'].");'><i class='fa fa-times'></i></button>
				</td>";
				echo "</tr>";
