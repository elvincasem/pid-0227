...
<div class="row">
   <div class="col-lg-12">
            ...
            <!-- END Input States Block -->
							...
							<button type="button" id="addbutton" class="btn btn-effect-ripple btn-primary" onclick="savedelivery();">Add Requisition</button>
	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><a href='#".$requisition_list['reqid']."'>".$requisition_list['requisition_no']."</a></td>";
				...
				echo "<td class='center'> 
					...
					<button class='btn btn-danger notification' title='Delete User' id='notification' onClick='deletedelivery(".$requisition_list['reqid'].")'><i class='fa fa-times'></i></button>
				</td>";
				echo "</tr>";
