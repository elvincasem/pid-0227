...
class Items_model extends CI_Model
{
    ...
    (SELECT 'Received' AS operation,purchase_receiving_items.drno AS reference,purchase_receiving_items.itemNo,purchase_receiving_items.unit,purchase_receiving_items.qty,purchase_receiving_items.time_stamp AS created FROM purchase_receiving_items) UNION ALL (SELECT 'Issued' AS operation,requisition_items.requisition_no AS reference,requisition_items.itemNo,requisition_items.unit,requisition_items.qty,requisition_items.time_stamp AS created FROM requisition_items)
) results WHERE results.itemNo = $id ORDER BY created ASC ");
		return $sql->result_array();
